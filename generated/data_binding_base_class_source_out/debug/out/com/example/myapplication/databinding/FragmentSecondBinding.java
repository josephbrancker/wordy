...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  private FragmentSecondBinding(@NonNull ConstraintLayout rootView, @NonNull EditText textView) {
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSecondBinding((ConstraintLayout) rootView, textView);
    }
